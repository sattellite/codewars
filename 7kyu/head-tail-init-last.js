/**
 * URL https://www.codewars.com/kata/head-tail-init-and-last
 *
 ...
 * Your job is to implement these functions in your given language. Make sure
 * it doesn't edit the array; that would cause problems! Here's a cheat sheet:
 *
 * | HEAD | <----------- TAIL ------------> |
 ...
 * one for each operation. There are 400 tests overall. No empty arrays will
...
const last = list => list.slice(-1).pop();
